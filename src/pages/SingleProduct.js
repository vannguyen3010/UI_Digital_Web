...
const SingleProduct = () => {
  ...
  return (
    <>
      ...
      <Container class1='main-product-wrapper py-5 homer-wrapper-2'>
            <div className='row'>
              <div className='col-6'>
                ...
                <div className="other-product-images d-flex flex-wrap gap-15">
                  <div><img src="https://staticimg.titan.co.in/Titan/Catalog/2656WM01_1.jpg?impolicy=pqmed&imwidth=640" className="img-fluid" alt=""/></div>
                  <div><img src="https://staticimg.titan.co.in/Titan/Catalog/2656WM01_1.jpg?impolicy=pqmed&imwidth=640" className="img-fluid" alt=""/></div>
                  <div><img src="https://staticimg.titan.co.in/Titan/Catalog/2656WM01_1.jpg?impolicy=pqmed&imwidth=640" className="img-fluid" alt=""/></div>
                  <div><img src="https://staticimg.titan.co.in/Titan/Catalog/2656WM01_1.jpg?impolicy=pqmed&imwidth=640" className="img-fluid" alt=""/></div>
                </div>
              ...
              <div className='col-6'>
                <div className="main-product-details">
                  ...
                  <div className="py-3">
                    ...
                    <div className='d-flex gap-10 align-items-center my-2'>
                      <h3 className='product'>Availablity :</h3>
                      <p className='product-data'>In Stock</p>
                    </div>
                    <div className='d-flex gap-10 flex-column mt-2 mb-3'>
                      <h3 className='product'>Size :</h3>
                    ...
                    <div className='d-flex gap-10 flex-column mt-2 mb-3'>
                      <h3 className='product'>Color :</h3>
                      <Color/>
                    </div>
                    <div className='d-flex align-items-center gap-15 flex-row gap-15 flex-row mt-2 mb-3'>
                    ...
                    <div className='d-flex gap-10 flex-column my-3'>
                      <h3 className='product'>Shipping & Returns</h3>
                      <p className='product-data'>
                        Free shipping and return available on all order!<br/> We shipping
                        all US domestic orders within <b>5-10 business days!</b>
                      </p>
                    </div>
                    <div className='d-flex gap-10 align-items-center my-3'>
                      <h3 className='product'>Product Link</h3>
                      <a 
